...
//! Project version number for OmiliaSdk.
FOUNDATION_EXPORT double OmiliaSdkVersionNumber;

//! Project version string for OmiliaSdk.
FOUNDATION_EXPORT const unsigned char OmiliaSdkVersionString[];
